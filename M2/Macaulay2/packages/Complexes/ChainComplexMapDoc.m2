...
doc ///
    Key
        (basis, List, ComplexMap)
        (basis, ZZ, ComplexMap)
    Headline
        extract a basis or generating set of a map of complexes
    Usage
        basis(d, f)
    Inputs
        d:{ZZ,List}  -- a degree or degree vector
        f:ComplexMap -- homogeneous
    Outputs
        :ComplexMap
    Description
        Text
          If $f$ is a graded (homogeneous) map of complexes and $d$ is a degree, this method
          computes the induced map on subcomplexes generated by the degree $d$ part of the
