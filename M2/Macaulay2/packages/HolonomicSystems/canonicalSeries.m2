...
invKludge = (R, n, i, e) -> (
    if   0 <= i and i <   n then (if e >= 0 then R_i^e else error "encountered negative exponent on partial variable") else
    if   n <= i and i < 2*n then (if e >= 0 then R_i^e else R_(2*n+i)^(-e)) else
    if 2*n <= i and i < 3*n then (if e >= 0 then R_i^e else error "encountered negative exponent on log variable") else
    if 3*n <= i and i < 4*n then (if e >= 0 then R_i^e else R_(i-2*n)^(-e)) else
